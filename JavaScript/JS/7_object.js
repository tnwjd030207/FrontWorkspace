test1.onclick = function(){
    /*
        Object
        - {속성값 : 속성값}으로 구성된 요소를 관리하는 개체를 의미
...
test3.onclick = function(){
    ...
    for(var key in game){
        ...
        console.log("value :"+game.key); //점표기법으로 기재
...
test7.onclick = function(){
    /*
        ...
        * prototype?
          - 모든 함수가 묵시적으로 가지고 있는 속성으로,
            부모 객체를 저장해두는 저장공간  
    */
   function pet(kind, name, breed, weighr){
    //{}
    //필드부
...
test8.onclick = function(){
    ...
    class pet extends Amimal{
        constructor(kind, name,breed, weighr){
            super(kind);
            this.name=name;
            this.breed=breed;
            this.weighr=weighr;
