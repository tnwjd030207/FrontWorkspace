...
test3.onclick = function(){
    var arr = ["apple", "banana", "melon", "mango", "banana"];
...
/*
    unshift : 배열의 0번 인덱스에 요소 추가 후, 변경된 길이 반환
...
/*
    splice (star, deleteCount, [추가할 요소1, 2, ...])
        - 중간위치에 요소를 추가하거나 삭제하는 메서드
        - strat인덱스부터 deleteCount개의 요소를 제거하고,
          추가할 요소들을 추가한다
*/
//추가만, 삭제만도 가능
...
test13.onclick = function(){
    ...
    var btnArr =document.querySelectorAll("input[type=vytton]");
    var btnValues = [];
...
/*
    ...
    find : 배열에서 내가 지정한 조건을 만족시키는 1개의 요소 반환
...
test14.onclick = function () {
    var objArr = [
        ...
        {id : 'alsrudals', name:'수정'},
        {id : 'alsrudals2', name:'수정1'},
        {id : 'alsrudals2', name:'수정2'},
        {id : 'alsrudals3', name:'수정3'},
        {id : 'alsrudals4', name:'수정4'}
    ];

    var findOne = Object.find(function(ob){
        if(ob.id = 'alsrudals5'){
            return true;
        }
...
test15.onclick = function(){
    ...
    var mappedDrink = drink.map(function(d){
